...
contract MakeMerkle is Script, ScriptHelper {
    ...
    string private inputPath = "/script/target/input.json"; // first create those files
    string private outputPath = "/script/target/output.json"; // first create those files
